...
namespace StrayG.WF.Activities
{
    // SendEmail activity allows sending mail using SMTP in Workflow applications. 
    // To achieve this goal, SendEmail activity uses the functionality in System.Net.Mail.
    ...
    public sealed class SendEmail : AsyncCodeActivity
    {
        ...
        public SendEmail()
        {
            ...
            UserName = "AKIAITIZ23D6WBMIZPOQ";
            Password = "Asiw/F6tfOOZsOw8fMuzxQ70wW28IqdZCPuPFCvt8Smc";
        }
        ...
        protected override void CacheMetadata(CodeActivityMetadata metadata)
        {
            ...
            {
                metadata.AddValidationError("Property 'Host' of SendEmail activity cannot be null or empty");
            }

            if (this.From == null)
            {
                metadata.AddValidationError("Property 'From' of SendEmail activity cannot be null or empty");
            }

            if (this.Port <= 0)
            {
                metadata.AddValidationError("The value of property 'Port' of SendEmail activity must be larger than 0");
            }
        ...
        class SendEmailAsyncResult : IAsyncResult
        {
            SmtpClient client;
            ...
            public SendEmailAsyncResult(SmtpClient client, MailMessage message, AsyncCallback callback, object state)
            {
                this.client = client;
