...
{
    /// <summary>
    /// Context passed when a Challenge causes a redirect to authorize endpoint in the USAF OAuth 2.0 middleware
    /// </summary>
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Auth",
        Justification = "OAuth2 is a valid word.")]
    public class USAFOAuth2ApplyRedirectContext : BaseContext<USAFOAuth2AuthenticationOptions>
    {
        /// <summary>
        /// Creates a new context object.
        /// </summary>
        /// <param name="context">The OWIN request context</param>
        /// <param name="options">The USAF OAuth 2.0 middleware options</param>
        ...
        public USAFOAuth2ApplyRedirectContext(IOwinContext context, USAFOAuth2AuthenticationOptions options,
