...
using StrayG.Security.USAF.Provider;

namespace StrayG.Security.USAF
{
    internal class USAFOAuth2AuthenticationHandler : AuthenticationHandler<USAFOAuth2AuthenticationOptions>
    {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                var context = new USAFOAuth2AuthenticatedContext(Context, user, response);
                ...
                {
                    context.Identity.AddClaim(new Claim("urn:USAF:profile", context.Profile, ClaimValueTypes.String,
                        Options.AuthenticationType));
                }
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            if (challenge != null)
            {
                ...
                var redirectContext = new USAFOAuth2ApplyRedirectContext(
                    Context, Options,
        ...
        private async Task<bool> InvokeReplyPathAsync()
        {
            if (Options.CallbackPath.HasValue && Options.CallbackPath == Request.Path)
            {
                ...
                var context = new USAFOAuth2ReturnEndpointContext(Context, ticket);
